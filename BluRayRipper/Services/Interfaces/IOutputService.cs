...
public interface IOutputService
{
    ...
    /// </summary>
    ObservableCollection<OutputFile> Items { get; }
    ...
    Task RemoveAsync(OutputFile outputFile);

    /// <summary>
    /// Updates the output file and writes the json to disk.
    /// </summary>
    /// <param name="outputFile">The output info.</param>
    Task UpdateAsync(OutputFile outputFile);
    ...
    OutputFile? GetByPlaylist(string diskName, ushort playlistId);
